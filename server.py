...
game_states = {}
words = ["python", "java", "javascript","socket", "advance", "programming", "server", "firewall", 
         "security", "latency", "encryption", "technology", "communication", "university", "security", 
         "firewall", "artificial", "cybersecurity", "apple", "cake", "chair", "student", "owl", "network"]
